...
def generate_graph():
    ...
    results = [
        ...
        # Robyn
        {"framework": "Robyn", "endpoint": "/", "requests_sec": 6451},
        {"framework": "Robyn", "endpoint": "/json", "requests_sec": 5373},
        {"framework": "Robyn", "endpoint": "/user/10", "requests_sec": 7654},
        # Falcon
    ...
    # Mock Workers string
    workers_str = "BustAPI:1, Catzilla:1, Flask:4, FastAPI:4, Robyn:4, Sanic:4, Falcon:4, Bottle:4, Django:4, BlackSheep:4"
    info_text = (
