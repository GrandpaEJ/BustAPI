...
class FrameworkComparison:
    ...
    def run_simple_benchmark(self, duration: int = 10, concurrent: int = 50) -> Dict:
        ...
        return {
            ...
            'error_rate': round(total_errors / (total_requests + total_errors) * 100, 2) if (total_requests + total_errors) > 0 else 0
        }
    ...
    def print_comparison(self, results: Dict):
        ...
        if len(valid_frameworks) > 1:
            ...
            for framework, result in sorted_frameworks[1:]:
                ...
                print(f"   {sorted_frameworks[0][0]} is {improvement:.1f}% faster than {framework}")
...
def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '--help':
        print("Framework Performance Comparison")
        print("Usage: python framework_comparison.py [--create-servers] [--save-results]")
