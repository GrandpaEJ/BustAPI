...
class Request:
    ...
    def get_data(self, cache: bool = True, as_text: bool = False, 
                 parse_form_data: bool = False) -> Union[bytes, str]:
        """
    ...
    def is_secure(self) -> bool:
        ...
        if self._rust_request:
            return self._rust_request.is_secure if hasattr(self._rust_request, 'is_secure') else False
        return False
...
class EnvironHeaders:
    ...
    def get(self, key: str, default: Optional[str] = None, type_func: Optional[callable] = None) -> Any:
        """
        Get header value.
