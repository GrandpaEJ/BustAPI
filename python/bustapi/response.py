...
class Response:
    ...
    def __init__(self, response: Any = None, status: Optional[int] = None,
                 headers: Optional[Union[Dict, Headers]] = None,
                 mimetype: Optional[str] = None, content_type: Optional[str] = None):
        """
...
def send_file(file_path: str, mimetype: Optional[str] = None, 
