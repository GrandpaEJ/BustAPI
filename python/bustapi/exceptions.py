...
class MethodNotAllowed(HTTPException):
    ...
    def __init__(self, description: Optional[str] = None, response=None, valid_methods=None):
...
class TooManyRequests(HTTPException):
    ...
    def __init__(self, description: Optional[str] = None, response=None, retry_after=None):
...
class InternalServerError(HTTPException):
    ...
    def __init__(self, description: Optional[str] = None, response=None, original_exception=None):
