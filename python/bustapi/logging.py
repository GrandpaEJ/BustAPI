...
class ColoredFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        log_line = f"{timestamp_colored} {level_colored} {logger_name_colored:20} {message}"
...
def request(method: str, path: str, status_code: int, duration: float = None, error: str = None):
...
if __name__ == "__main__":
    ...
    demo_logger.log_request("POST", "/api/error", 500, 0.089, "Database connection failed")  # With error
