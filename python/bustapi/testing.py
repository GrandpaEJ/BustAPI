...
class TestClient:
    ...
    def open(self, path: str, method: str = 'GET', data: Optional[Union[str, bytes, dict]] = None,
             query_string: Optional[Union[str, dict]] = None, headers: Optional[Dict[str, str]] = None,
             content_type: Optional[str] = None, **kwargs) -> TestResponse:
        """
