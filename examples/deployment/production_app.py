...
def metrics():
    ...
    try:
        # Basic metrics
        metrics_data = [
            f'# HELP bustapi_info Application information',
            f'# TYPE bustapi_info gauge',
            f'bustapi_info{{version="{config.API_VERSION}",environment="{config.ENVIRONMENT}"}} 1',
            f'',
            f'# HELP bustapi_uptime_seconds Application uptime in seconds',
            f'# TYPE bustapi_uptime_seconds counter',
        ...
        try:
            ...
            metrics_data.extend([
                f'',
                f'# HELP bustapi_cpu_percent CPU usage percentage',
                f'# TYPE bustapi_cpu_percent gauge',
                f'bustapi_cpu_percent {cpu_percent}',
                f'',
                f'# HELP bustapi_memory_percent Memory usage percentage',
                f'# TYPE bustapi_memory_percent gauge',
